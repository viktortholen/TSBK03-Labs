...
void init(void)
{
    ...
    lowpass = loadShaders("lowpass.vert", "lowpass.frag");  // puts texture on teapot
    truncate = loadShaders("truncate.vert", "truncate.frag");  // puts texture on teapot
    merger = loadShaders("merger.vert", "merger.frag");  // puts texture on teapot
